...
Shader "_Unity Shaders Book/Chapter 7/Chapter_7_2_Normal_world"
{
	Properties {
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput vert(VertexInput v){
				...
				// Compute the matrix that transform directions from 
			...
			fixed4 frag(VertexOutput i) : SV_Target {
				...
				// this is just another style of calculating matrix multiply
				...
				fixed3 diff = max(0, dot(bump, lightDir));
